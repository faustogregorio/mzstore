...
export class Container {
    ...
    getAlignedPositionOnPull(newPositionX: any) {
        const direction = this.getDirection();
    ...
    getCurrentPositionX() {
        const parentPosition: any = this.element.parentElement?.getBoundingClientRect();
    ...
    getEndPosition() {
        if (this.isLightDOM) {
            ...
            const visibleWidth: any = this.element.parentElement?.clientWidth;
            return visibleWidth - width;
        }
    }

    transformPositionX(value: any, duration = this.transitionDuration) {
        if (value === undefined) {
            return;
        }
    ...
    setInitialPosition(position: any) {
